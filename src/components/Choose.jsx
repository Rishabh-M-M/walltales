            ...
            <div className="space-y-8">
                ...
                >
                    ...
                    <div className="mb-6">
                        <Link
                            to="/about"
                            className="text-teal-600 hover:text-teal-900 font-semibold text-lg transition duration-200"
                        >
                            Explore More About Us &rarr;
                        </Link>
                    </div>
                    <p className="text-gray-700">
                        At Walltales, we are committed to providing top-quality products that offer
                        both style and durability. We believe that everyone should have access to
                        affordable and easy DIY solutions, and our peel and stick tiles are just one
                        example of our commitment to that mission.
                    </p>
                </motion.div>
