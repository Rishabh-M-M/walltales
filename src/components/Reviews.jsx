...
const testimonials = [
    {
        quote: "These tiles completely transformed my kitchen! Easy to install and look amazing.",
        name: "Sophia W.",
        title: "Verified Customer",
        rating: 5,
    },
    {
        quote: "The quality of the print is outstanding, and the material is so durable. Highly recommend!",
        name: "James T.",
        title: "Interior Designer",
        rating: 4,
    },
    {
        quote: "Love how waterproof and stainproof they are. Perfect for my busy household.",
        name: "Emily R.",
        title: "Homeowner",
        rating: 4,
    },
    {
        quote: "I’ve tried other brands, but nothing matches the adhesive strength of these tiles.",
        name: "Liam K.",
        title: "DIY Enthusiast",
        rating: 5,
    },
    {
        quote: "Affordable, stylish, and easy to maintain. I’ll definitely buy more for other rooms.",
        name: "Ava P.",
