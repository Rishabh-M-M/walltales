  ...
  return (
    <div className="h-[60vh] bg-teal-700 flex justify-center items-center">
      <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-6 md:p-8 shadow-lg bg-white dark:bg-black text-neutral-800 dark:text-neutral-200 transition-all ease-in-out duration-300">
        <h2 className="font-bold text-xl">Sign up for our Newsletter</h2>
        <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
          Stay updated with the latest news, tips, and updates. Sign up for our
          newsletter!
        </p>
        <form className="my-8" onSubmit={handleSubmit}>
          <LabelInputContainer className="mb-6">
            <Label
              htmlFor="email"
              className="transition-all duration-300 ease-in-out text-neutral-800 dark:text-neutral-200"
            >
              Email Address
            </Label>
            <Input
