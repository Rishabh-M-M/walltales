...
// Banner Image
import WTS_Banner from "@/assets/Products/Wall Tile Stickers/WTSbanner.jpeg";
        ...
        <>
            ...
            <div className="bg-gradient-to-b from-zinc-50 to-white px-4 text-center relative z-30 pb-16">
                ...
                <nav className="my-8 text-gray-500 text-lg md:text-xl">
                    ...
                    / Products / <span className="text-gray-700">Wall Tile Stickers</span>
                </nav>
...
export default WallTileStickers;
