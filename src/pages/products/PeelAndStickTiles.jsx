...
// Banner Image
import PAST_Banner from "@/assets/Products/Peel and Stick Tiles/PASTbanner.jpeg";
    ...
    return (
        <>
            ...
            <div className="relative w-full h-screen overflow-hidden">
                <img
                    src={PAST_Banner}
                    alt="Peel and Stick Tiles Banner"
            ...
            <div className="bg-gradient-to-b from-zinc-50 to-white px-4 text-center relative z-30 pb-16">
                ...
                <nav className="my-8 text-gray-500 text-lg md:text-xl">
                    ...
                    / Products / <span className="text-gray-700">Peel and Stick Tiles</span>
                </nav>
